                        ...
                        <DialogSurface aria-describedby={undefined}>
                            <form
                                onSubmit={(ev: React.FormEvent) => {
                                    ev.preventDefault();
                                    if (
                                        value.registeredEngines.includes(
                                            engine
                                        ) ||
                                        !apiKey
                                    )
                                    ...
                                    switch (engine) {
                                        ...
                                        case SupportedEngines.STABLEDIFFUSION:
                                            newEngine =
                                                new StableDiffusionImageGeneratorPlugin(
                                                    apiKey
                                                );
                                            break;
                                    ...
                                    <DialogContent>
                                        ...
                                        <Select
                                            ...
                                            onChange={(e) =>
                                                setEngine(
                                                    e.target
                                                        .value as SupportedEngines
                                                )
                                            }
                                        >
                                            {Object.keys(SupportedEngines).map(
                                                (key, index) => (
                                                    <option
                                                        key={key}
                                                        value={
                            ...
                            >
                                <Button
                                    ...
                                    onClick={() => {
                                        ...
                                        value.updateRegisteredEngines(
                                            value.registeredEngines.filter(
                                                (e) => e !== engine
                                            )
                                        );
                                        // store in localStorage
